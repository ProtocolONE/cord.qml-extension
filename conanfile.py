...
class QmlExtensionConan(ConanFile):
    ...
    requires = "Qt/5.5.1@common/stable", "Core/1.0.0@common/stable", "Settings/1.0.0@common/stable", "yaml-cpp/0.6.2@common/stable", "QtYaml/1.0.0@common/stable"
    build_requires = "Qt/5.5.1@common/stable", "Core/1.0.0@common/stable", "Settings/1.0.0@common/stable", "yaml-cpp/0.6.2@common/stable", "QtYaml/1.0.0@common/stable"
